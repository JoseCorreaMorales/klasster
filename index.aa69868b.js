(function() {
    ...
    var burgerMenu = function() {
        $("body").on("click", ".js-fh5co-nav-toggle", function(event) {
            var $this = $(this);
            if ($("body").hasClass("overflow offcanvas")) $("body").removeClass("overflow offcanvas");
            else $("body").addClass("overflow offcanvas");
    ...
    var counterWayPoint = function() {
        if ($("#fh5co-counter").length > 0) $("#fh5co-counter").waypoint(function(direction) {
